...
* **Manifest Assembly**: Once the native architecture-specific images are published, a final job runs `docker buildx imagetools create` to assemble them into a unified multi-architecture tag on Docker Hub.
